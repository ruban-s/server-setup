...
_generate_env_file() {
    ...
    cat > "$env_file" <<EOF
# Generated by servforge — Docker environment
...
EOF
    ...
    log_info "  sudo ./servforge.sh --start"
    log_info "  sudo ./servforge.sh --stop"
    log_info "  sudo ./servforge.sh --restart"
    echo ""
}
